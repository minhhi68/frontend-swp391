...
<html>
    <head>
        ...
        <link href="${contextPath}/assets/css/owl.carousel.min.css" rel="stylesheet">
        <link href="${contextPath}/assets/css/flaticon.css" rel="stylesheet">
        <link href="${contextPath}/assets/css/price_rangs.css" rel="stylesheet">
        <link href="${contextPath}/assets/css/slicknav.css" rel="stylesheet">
        <link href="${contextPath}/assets/css/animate.min.css" rel="stylesheet">
        <link href="${contextPath}/assets/css/magnific-popup.css" rel="stylesheet">
        <link href="${contextPath}/assets/css/fontawesome-all.min.css" rel="stylesheet">
        <link href="${contextPath}/assets/css/themify-icons.css" rel="stylesheet">
        <link href="${contextPath}/assets/css/slick.css" rel="stylesheet">
        <link href="${contextPath}/assets/css/nice-select.css" rel="stylesheet">
